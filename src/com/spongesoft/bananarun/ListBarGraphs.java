...
public class ListBarGraphs extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ActionItem prevItem = new ActionItem(ID_UP, "Average Speed",
				getResources().getDrawable(R.drawable.menu_ok));
		ActionItem searchItem = new ActionItem(ID_SEARCH, "Distance",
				getResources().getDrawable(R.drawable.menu_ok));
		ActionItem item = new ActionItem(ID_OK, "Kcal", getResources()
				.getDrawable(R.drawable.menu_ok));
